...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            "Clibde265\\libde265\\visualize.h"
        ],
        "extra_compile_args": [
            "/openmp"
        ],
        "include_dirs": [
            ...
            "./Clibde265/",
            "./Clibde265/libde265/",
            "C:\\Users\\11386\\AppData\\Local\\Temp\\build-env-ofur_2cr\\Lib\\site-packages\\numpy\\_core\\include"
        ],
        "language": "c++",
        "libraries": [
            "de265"
        ...
        "library_dirs": [
            "./Clibde265/build/libde265/Release/"
        ],
        "name": "pylibde265.visualize",
        "sources": [
            "./src/pylibde265/visualize.pyx"
        ]
    },
    "module_name": "pylibde265.visualize"
}
END: Cython Metadata */
...
#define __PYX_HAVE__pylibde265__visualize
#define __PYX_HAVE_API__pylibde265__visualize
/* Early includes */
#include "visualize.h"
#ifdef _OPENMP
#include <omp.h>
...
/* Module declarations from "pylibde265.visualize" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "pylibde265.visualize"
extern int __pyx_module_is_main_pylibde265__visualize;
int __pyx_module_is_main_pylibde265__visualize = 0;

/* Implementation of "pylibde265.visualize" */
...
#define __pyx_n_u_test __pyx_string_tab[4]
...
static CYTHON_SMALL_CODE int __pyx_m_clear(PyObject *m) {
  ...
  #endif
  for (int i=0; i<5; ++i) { Py_CLEAR(clear_module_state->__pyx_string_tab[i]); }
  return 0;
}
#endif
...
static CYTHON_SMALL_CODE int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  #endif
  for (int i=0; i<5; ++i) { __Pyx_VISIT_CONST(traverse_module_state->__pyx_string_tab[i]); }
  return 0;
}
#endif
...
static CYTHON_SMALL_CODE int __pyx_pymod_exec_visualize(PyObject *__pyx_pyinit_module)
#endif
{
  #if !CYTHON_PEP489_MULTI_PHASE_INIT
  if (__Pyx_VersionSanityCheck() < 0) return NULL;
  ...
  if (__pyx_m) {
    ...
    PyErr_SetString(PyExc_RuntimeError, "Module 'visualize' has already been imported. Re-initialisation is not supported.");
    return -1;
  }
  #else
  ...
  __pyx_t_1 = PyModule_Create(&__pyx_moduledef); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  {
    ...
    __pyx_t_1 = 0; /* transfer ownership from __pyx_t_1 to "visualize" pseudovariable */
...
__Pyx_RefNannySetupContext("PyInit_visualize", 0);
  ...
  if (__pyx_module_is_main_pylibde265__visualize) {
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "pylibde265.visualize")) {
      if (unlikely((PyDict_SetItemString(modules, "pylibde265.visualize", __pyx_m) < 0))) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init pylibde265.visualize", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init pylibde265.visualize");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  if (__Pyx_InitStrings(__pyx_string_tab, __pyx_mstate->__pyx_string_tab, __pyx_string_tab_encodings) < 0) __PYX_ERR(0, 2, __pyx_L1_error);
  return 0;
  __pyx_L1_error:;
  return -1;
}
